...
public class StoryScreen extends BaseScreen {
    ...
    public void initialize() {
        ...
        scene.addSegment(new SceneSegment(dialogBox, SceneActions.setText("I want to be the bery best ... Starfish collector!")));
    ...
    // after scene is finished the levelscreen should be loaded;
    @Override
